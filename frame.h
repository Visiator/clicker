...
public:
    ...
    unsigned char tcp_flags_urg;
    unsigned char tcp_flags_ack;
    unsigned char tcp_flags_push;
    unsigned char tcp_flags_reset;
    unsigned char tcp_flags_syn;
    unsigned char tcp_flags_fin;
    ...
    void get_packet_no_from_session(SESSIONS &sessions);
